...
interface Option {
  value: string;
  label: string;
  group?: string; // для группировки: "popular" / "all"
}
        ...
        <div className="absolute z-50 mt-1 w-full bg-zinc-800 border border-zinc-700 rounded-lg shadow-xl overflow-hidden">
          ...
          <div className="p-2 border-b border-zinc-700">
            <input
              ...
              className="w-full bg-zinc-900 border border-zinc-600 rounded px-2.5 py-1.5 text-sm placeholder-zinc-500 focus:outline-none focus:ring-1 focus:ring-orange-500"
            />
          </div>
          ...
          <div className="max-h-60 overflow-y-auto">
            ...
            {filtered.length === 0 && (
              <p className="px-3 py-3 text-sm text-zinc-500 text-center">—</p>
            )}
          </div>
        </div>
      )}
