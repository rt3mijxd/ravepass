...
export const countryNames: Record<string, string> = {
  // СНГ и соседи
  RU: "Россия", BY: "Беларусь", UA: "Украина", MD: "Молдова",
  GE: "Грузия", AM: "Армения", AZ: "Азербайджан",
  KZ: "Казахстан", KG: "Кыргызстан", UZ: "Узбекистан", TJ: "Таджикистан",
  TM: "Туркменистан", MN: "Монголия",
  // Европа
  GB: "Великобритания", IE: "Ирландия", FR: "Франция", DE: "Германия",
  ES: "Испания", PT: "Португалия", IT: "Италия", NL: "Нидерланды",
  BE: "Бельгия", LU: "Люксембург", CH: "Швейцария", AT: "Австрия",
  PL: "Польша", CZ: "Чехия", SK: "Словакия", HU: "Венгрия",
  RO: "Румыния", BG: "Болгария", GR: "Греция", HR: "Хорватия",
  SI: "Словения", RS: "Сербия", ME: "Черногория", MK: "Северная Македония",
  BA: "Босния и Герцеговина", AL: "Албания", XK: "Косово",
  SE: "Швеция", NO: "Норвегия", FI: "Финляндия", DK: "Дания",
  IS: "Исландия", LT: "Литва", LV: "Латвия", EE: "Эстония",
  CY: "Кипр", MT: "Мальта", AD: "Андорра",
  // Ближний Восток
  TR: "Турция", IL: "Израиль", AE: "ОАЭ", SA: "Саудовская Аравия",
  QA: "Катар", BH: "Бахрейн", KW: "Кувейт", OM: "Оман",
  JO: "Иордания", LB: "Ливан", SY: "Сирия", IQ: "Ирак",
  IR: "Иран", YE: "Йемен",
  // Азия
  CN: "Китай", JP: "Япония", KR: "Южная Корея", KP: "Северная Корея",
  TW: "Тайвань", HK: "Гонконг", SG: "Сингапур", MY: "Малайзия",
  TH: "Таиланд", VN: "Вьетнам", ID: "Индонезия", PH: "Филиппины",
  IN: "Индия", PK: "Пакистан", BD: "Бангладеш", LK: "Шри-Ланка",
  NP: "Непал", MM: "Мьянма", KH: "Камбоджа", LA: "Лаос",
  AF: "Афганистан", MV: "Мальдивы", BT: "Бутан", BN: "Бруней",
  TL: "Восточный Тимор",
  // Африка
  EG: "Египет", MA: "Марокко", TN: "Тунис", DZ: "Алжир",
  LY: "Ливия", ZA: "ЮАР", NG: "Нигерия", KE: "Кения",
  ET: "Эфиопия", TZ: "Танзания", UG: "Уганда", GH: "Гана",
  SN: "Сенегал", CI: "Кот-д’Ивуар", CM: "Камерун", AO: "Ангола",
  MZ: "Мозамбик", ZW: "Зимбабве", ZM: "Замбия", BW: "Ботсвана",
  NA: "Намибия", MG: "Мадагаскар", SD: "Судан", SS: "Южный Судан",
  CD: "ДР Конго", CG: "Республика Конго", ML: "Мали", NE: "Нигер",
  TD: "Чад", SO: "Сомали", RW: "Руанда", BF: "Буркина-Фасо",
  GN: "Гвинея", BJ: "Бенин", BI: "Бурунди", GA: "Габон",
  MR: "Мавритания", LR: "Либерия", SL: "Сьерра-Леоне", TG: "Того",
  ER: "Эритрея", CF: "ЦАР", GM: "Гамбия", LS: "Лесото",
  GW: "Гвинея-Бисау", SZ: "Эсватини", DJ: "Джибути", GQ: "Экв. Гвинея",
  MW: "Малави",
  // Америка
  US: "США", CA: "Канада", MX: "Мексика", GL: "Гренландия",
  BR: "Бразилия", AR: "Аргентина", CL: "Чили", CO: "Колумбия",
  PE: "Перу", VE: "Венесуэла", EC: "Эквадор", BO: "Боливия",
  PY: "Парагвай", UY: "Уругвай", GY: "Гайана", SR: "Суринам",
  CU: "Куба", DO: "Доминикана", HT: "Гаити", JM: "Ямайка",
  FK: "Фолклендские острова", EH: "Западная Сахара",
  GT: "Гватемала", HN: "Гондурас", NI: "Никарагуа", CR: "Коста-Рика",
  PA: "Панама", SV: "Сальвадор", BZ: "Белиз", BS: "Багамы",
  TT: "Тринидад и Тобаго", PR: "Пуэрто-Рико",
  // Океания
  AU: "Австралия", NZ: "Новая Зеландия", PG: "Папуа — Новая Гвинея",
  FJ: "Фиджи", SB: "Соломоновы Острова", VU: "Вануату", NC: "Новая Каледония",
};
