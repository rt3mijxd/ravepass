...
// Общий модуль: используется и большой картой, и мини-картой на странице артиста.
export const numericToAlpha2: Record<number, string> = {
  ...
  246: "FI", 250: "FR", 262: "DJ", 266: "GA", 268: "GE", 270: "GM", 276: "DE", 288: "GH",
...
// URL карты мира (TopoJSON, кэшируется браузером)
